...
Barcodes = {'S:\OperaQEHS\OperaDB\Javier Jarazo\JJ_20200619_10X_Diff_Staging_Day_7_S2_R1',...
            'S:\OperaQEHS\OperaDB\Javier Jarazo\JJ_20200619_10X_Diff_Staging_Day_7_S2_R2',...
            'S:\OperaQEHS\OperaDB\Javier Jarazo\JJ_20200619_10X_Diff_Staging_Day_7_S2_R3',...
            'S:\OperaQEHS\OperaDB\Javier Jarazo\JJ_20200619_10X_Diff_Staging_Day_14_S2_R1',...
            'S:\OperaQEHS\OperaDB\Javier Jarazo\JJ_20200619_10X_Diff_Staging_Day_14_S2_R2',...
            'S:\OperaQEHS\OperaDB\Javier Jarazo\JJ_20200619_10X_Diff_Staging_Day_14_S2_R3',...
            'S:\OperaQEHS\OperaDB\Javier Jarazo\JJ_20200624_10X_Diff_Staging_Day_21_S2_R1',...
            'S:\OperaQEHS\OperaDB\Javier Jarazo\JJ_20200624_10X_Diff_Staging_Day_21_S2_R2',...
            'S:\OperaQEHS\OperaDB\Javier Jarazo\JJ_20200624_10X_Diff_Staging_Day_21_S2_R3'};
...
for b = 1:size(Barcodes, 2) %loop over barcodes
    ...
    SavePathBegining = {'Y:\16-Our Papers\In Preparation\PINK1\PNAS\Revision\New_figures\Figure_1\Originals\GH\Script_output\'};
    ...
    parfor f=1:height(InfoTable)%loop over fields
        ...
        ch2 = cube.data(:,:,:,2); %S100b % it(ch2)
        ch3 = cube.data(:,:,:,3); %TH % it(ch3)
        ch4 = cube.data(:,:,:,4); %GFAP % it(ch4)
       
        Objects = Analysis_Astro_activ(InfoTableThis,PreviewPath, ch1, ch2, ch3, ch4);
