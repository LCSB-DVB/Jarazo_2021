function [Objects] = Analysis_Astro_propor(InfoTableThis,DataPath, ch1, ch2, ch3, ch4)
...
%% Segment neurons
    ...
    NeuroMaskGlobal = NeuroSegmentationImGlobal > 200;  % it(NeuroMaskGlobal)
    NeuroMaskLocal = NeuroSegmentationImLocal > 2;  % it(NeuroMaskLocal)
