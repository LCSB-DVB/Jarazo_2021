...
## Load data ##
###############
N1=read.table('S:/HCS_Platform/Data/JavierJarazo/Autophagy_modulation/S3/JJ_20200727_10X_Autophagy_Modulation_Chloro_S3_C1_R1/Analysis_20200730_102752/Objects.csv',header=TRUE, sep=',',stringsAsFactors = FALSE)
N2=read.table('S:/HCS_Platform/Data/JavierJarazo/Autophagy_modulation/S3/JJ_20200727_10X_Autophagy_Modulation_Chloro_S3_C1_R2/Analysis_20200730_103058/Objects.csv',header=TRUE, sep=',',stringsAsFactors = FALSE)
N3=read.table('S:/HCS_Platform/Data/JavierJarazo/Autophagy_modulation/S3/JJ_20200727_10X_Autophagy_Modulation_Chloro_S3_C1_R3/Analysis_20200730_103426/Objects.csv',header=TRUE, sep=',',stringsAsFactors = FALSE)
N4=read.table('S:/HCS_Platform/Data/JavierJarazo/Autophagy_modulation/S3/JJ_20200728_10X_Autophagy_Modulation_Chloro_S3_C2_R1/Analysis_20200730_110005/Objects.csv',header=TRUE, sep=',',stringsAsFactors = FALSE)
N5=read.table('S:/HCS_Platform/Data/JavierJarazo/Autophagy_modulation/S3/JJ_20200728_10X_Autophagy_Modulation_Chloro_S3_C2_R2/Analysis_20200730_110355/Objects.csv',header=TRUE, sep=',',stringsAsFactors = FALSE)
N6=read.table('S:/HCS_Platform/Data/JavierJarazo/Autophagy_modulation/S3/JJ_20200728_10X_Autophagy_Modulation_Chloro_S3_C2_R3/Analysis_20200730_110739/Objects.csv',header=TRUE, sep=',',stringsAsFactors = FALSE)
...
Table_all %>% 
  dplyr::filter(NucVol %between% c(5000,300000))->Table_all

saveRDS(Table_all,"Table_all_Autophagy_modul_S3.rdata")

interesting_features = c("THbyNucVol","THbyTHVol", "Tuj1byTuj1Vol","Tuj1byNucVol",
                         "GFAPbyGFAPVol","GFAPbyNucVol", "THVolByTuj1Vol","Tuj1VolByNucVol","THVolByNucVol",
                         "GFAPVolByNucVol","GFAPVolByTHVol","GFAPVolByTuj1Vol","ColoTHTuj1VolByNucVol",
                         "ColoTHTuj1VolByTuj1Vol","Tuj1Vol","THVol","NucVol","GFAPVol","ColoTHTuj1Vol")

metadata =c("files","Row","Column","field","AreaName", 
            "Barcode","Line","Treatment","Concentration","Condition","Category")
...
saveRDS(All_tidy,"All_tidy_autophagy_modul_S3.rdata")
...
p=ggdraw() +
  draw_plot(graph[[2]], x = .0, y = .0, width = .15, height = .15) +
  draw_plot(graph[[1]], x = .15, y = .0, width = .15, height = .15) +
  draw_plot(graph[[3]], x = .0, y = .15, width = .15, height = .15) +
  draw_plot(graph[[4]], x = .15, y = .15, width = .15, height = .15) +
  draw_plot(graph[[5]], x = .3, y = .15, width = .15, height = .15) +
  draw_plot(my_legend, x = .63, y = .2, width = .00000001, height = .00000001)

ggsave("Autophagy_modul_S3.pdf", plot=p, dpi=320, width = 11.69 , height = 8.27, units = "in",device=cairo_pdf)
...
write.table(table_results, "KW_wanted_comparisons_All_features_Automodul_S3.csv", sep = ',', row.names = FALSE)
...
table_results$Handle2 = tmp[,2]
  ...
  write.table(All_merged, "KW_wanted_comparisons_All_features_Automodul_S3_SM.csv", sep = ',', row.names = FALSE)
