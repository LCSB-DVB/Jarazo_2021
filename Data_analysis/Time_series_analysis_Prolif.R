...
N1=read.table("S:/HCS_Platform/Data/JavierJarazo/Staging/Prolif_JJ_20171219_20X_Diff_Prolif_d7_N1/Analysis_20171228_154509/Objects.txt",header=TRUE, sep=',',stringsAsFactors = FALSE)
N2=read.table("S:/HCS_Platform/Data/JavierJarazo/Staging/Prolif_JJ_20171219_20X_Diff_Prolif_d7_N2/Analysis_20171228_154630/Objects.txt",header=TRUE, sep=',',stringsAsFactors = FALSE)
N3=read.table("S:/HCS_Platform/Data/JavierJarazo/Staging/Prolif_JJ_20171219_20X_Diff_Prolif_d7_N3/Analysis_20171228_154648/Objects.txt",header=TRUE, sep=',',stringsAsFactors = FALSE)
N4=read.table("S:/HCS_Platform/Data/JavierJarazo/Staging/Prolif_JJ_20171219_20X_Diff_Prolif_d14_N1/Analysis_20171228_154704/Objects.txt",header=TRUE, sep=',',stringsAsFactors = FALSE)
N5=read.table("S:/HCS_Platform/Data/JavierJarazo/Staging/Prolif_JJ_20171219_20X_Diff_Prolif_d14_N2/Analysis_20171228_154722/Objects.txt",header=TRUE, sep=',',stringsAsFactors = FALSE)
N6=read.table("S:/HCS_Platform/Data/JavierJarazo/Staging/Prolif_JJ_20171219_20X_Diff_Prolif_d14_N3/Analysis_20171228_154739/Objects.txt",header=TRUE, sep=',',stringsAsFactors = FALSE)
N7=read.table("S:/HCS_Platform/Data/JavierJarazo/Staging/Prolif_JJ_20171219_20X_Diff_Prolif_d21_N1/Analysis_20171228_154757/Objects.txt",header=TRUE, sep=',',stringsAsFactors = FALSE)
N8=read.table("S:/HCS_Platform/Data/JavierJarazo/Staging/Prolif_JJ_20171219_20X_Diff_Prolif_d21_N2/Analysis_20171228_154814/Objects.txt",header=TRUE, sep=',',stringsAsFactors = FALSE)
N9=read.table("S:/HCS_Platform/Data/JavierJarazo/Staging/Prolif_JJ_20171219_20X_Diff_Prolif_d21_N3/Analysis_20171228_154832/Objects.txt",header=TRUE, sep=',',stringsAsFactors = FALSE)
N10=read.table("S:/HCS_Platform/Data/JavierJarazo/Staging/Prolif_JJ_20171219_20X_Diff_Prolif_d42/Analysis_20171228_154849/Objects.txt",header=TRUE, sep=',',stringsAsFactors = FALSE)
...
#write.csv(toto2, "P:/Scripts/R/GGPlot_scripts/Heatmaps_all_features/TablesAll_prolif_2.csv",row.names=FALSE)

Limit_y_axis = data.table(Features = Features, X1= c(0), X2= c(0.4))
graph = list()
...
# Reduce(`+`, graph) * theme(legend.position = "bottom",legend.text=element_text(size=rel(0.5)), legend.title=element_blank())
p=ggdraw() +
  draw_plot(graph[[1]], x = 0, y = .2, width = .2, height = .2)
ggsave("Timeseries_Proliferation.pdf", plot=last_plot(), dpi=320, width = 11.69 , height = 8.27, units = "in",device=cairo_pdf)
...
write.table(table_results, "KW_wanted_comparisons_Diff_staging_prolif.csv", sep = ',', row.names = FALSE)
